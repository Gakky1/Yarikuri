...
struct PrefectureSelectSheet: View {
    ...
    static let municipalitiesByPref: [String: [String]] = [
        ...
        "埼玉県": ["さいたま市", "川口市", "越谷市", "所沢市", "川越市", "熊谷市"],
        "千葉県": ["千葉市", "船橋市", "松戸市", "市川市", "柏市", "八千代市"],
        "東京都": ["新宿区", "渋谷区", "港区", "世田谷区", "練馬区", "足立区", "江戸川区",
                   "八王子市", "立川市", "町田市", "府中市", "調布市"],
        "神奈川県": ["横浜市", "川崎市", "相模原市", "横須賀市", "藤沢市", "平塚市"],
        "新潟県": ["新潟市", "長岡市", "上越市"],
        "静岡県": ["静岡市", "浜松市", "沼津市", "富士市"],
        "愛知県": ["名古屋市", "豊田市", "豊橋市", "岡崎市", "一宮市", "春日井市"],
        "京都府": ["京都市", "宇治市", "亀岡市"],
        "大阪府": ["大阪市", "堺市", "東大阪市", "豊中市", "高槻市", "枚方市"],
        "兵庫県": ["神戸市", "姫路市", "西宮市", "尼崎市", "明石市", "加古川市"],
        "広島県": ["広島市", "福山市", "呉市", "東広島市"],
        "福岡県": ["福岡市", "北九州市", "久留米市", "飯塚市"],
        "熊本県": ["熊本市", "八代市", "天草市"],
        "沖縄県": ["那覇市", "沖縄市", "宜野湾市", "うるま市"],
    ]
