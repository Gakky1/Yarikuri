...
final class OnboardingViewModel: ObservableObject {
    ...
    // MARK: - カスタマイズ
    @Published var appIconStyle: Int = 0
    @Published var themeColorStyle: Int = 0
    ...
    func nextStep() {
        ...
        case .concern: currentStep = .customize
        case .customize: break
        }
    }
    ...
    func previousStep() {
        ...
        case .customize: currentStep = .concern
        }
    }
    ...
    var isLastStep: Bool { currentStep == .customize }
...
enum OnboardingStep: Int, CaseIterable {
    ...
    var title: String {
        ...
        case .customize: return "アプリをカスタマイズしよう"
        }
    }
    ...
    var subtitle: String {
        ...
        case .customize: return "あとで設定から変更できます"
        }
    }
}
